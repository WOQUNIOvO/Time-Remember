...
import com.timeremember.security.JwtAuthenticationFilter;
        ...
        return http
                ...
                .exceptionHandling(exception -> exception
                        .authenticationEntryPoint((request, response, authException) -> writeJson(response,
                                HttpServletResponse.SC_UNAUTHORIZED, "{\"code\":401,\"message\":\"请先登录\",\"data\":null}"))
                        .accessDeniedHandler((request, response, accessDeniedException) -> writeJson(response,
                                HttpServletResponse.SC_FORBIDDEN, "{\"code\":403,\"message\":\"无权访问\",\"data\":null}"))
                )
